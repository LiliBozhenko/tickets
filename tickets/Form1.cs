...
namespace tickets
{
    public partial class Form1 : Form
    {
            ...
            SaveFileDialog saveFileDialog = new SaveFileDialog();
                if (saveFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    for (int i = 0; i < 25; i++)
                    {
                        ...
                        p.AddHeader("3. " + s[2], 0, 10f, 3);
                        p.AddHeader("4. " + s[3], 0, 10f, 3);
                        p.AddHeader("Затвердженно на засіданні Кафедри комп'ютерних систем, мереж та кібербезпеки(503)", 0, 1.16f, 3);
        ...
        private void ticketlistopen()
        {
            ...
            var doc = DocX.Load("ticketlist.docx");
            for (int i = 0; i < 4; i++)
            {
                //випадкове число
            ...
            if (CheckComboboxesAreNotNull())
            {
                ...
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    for (int i = 0; i < 25; i++)
                    {
                        ...
                        w.AddParagraph("3. " + s[2], Xceed.Document.NET.Alignment.left, System.Drawing.Color.Black, false, false, 10);
                        w.AddParagraph("4. " + s[3], Xceed.Document.NET.Alignment.left, System.Drawing.Color.Black, false, false, 10);
                        w.AddParagraph("Затвердженно на засіданні Кафедри комп'ютерних систем, мереж та кібербезпеки(503)", Xceed.Document.NET.Alignment.left, System.Drawing.Color.Black);
